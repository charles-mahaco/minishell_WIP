...
{
	if (!ft_strncmp(cmd, "cd", ft_strlen1(cmd))
		|| !ft_strncmp(cmd, "pwd", ft_strlen1(cmd))
		|| !ft_strncmp(cmd, "env", ft_strlen1(cmd))
		|| !ft_strncmp(cmd, "export", ft_strlen1(cmd))
		|| !ft_strncmp(cmd, "echo", ft_strlen1(cmd))
		|| !ft_strncmp(cmd, "unset", ft_strlen1(cmd)))
		return (true);
	else
		return (false);
}
